                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px 40px;font-family:'Lato',sans-serif;" align="left">
                                                            ...
                                                            <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 28px;">
                                                                <div><strong>@yield('subject','Mail Subject')</strong></div>
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 30px 70px;font-family:'Lato',sans-serif;" align="left">
                                                            ...
                                                            <div style="color: #333333; line-height: 190%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 190%;"><span style="font-size: 16px; line-height: 30.4px;">Thanks,</span></p>
                                                                <p style="font-size: 14px; line-height: 190%;"><span style="font-size: 16px; line-height: 30.4px;"><strong>NEXTGEN Optima Team</strong></span></p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 20px;font-family:'Lato',sans-serif;" align="left">
                                                            ...
                                                            <div style="color: #8d8c8c; line-height: 190%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 190%;">
                                                                    ...
                                                                    <br />
                                                                    <span style="text-decoration: underline; font-size: 14px; line-height: 26.6px;">
                                                                        <a href="//{{config('mail.template.website')}}" style="color: #f1602a; font-size: 14px; line-height: 26.6px; text-decoration: underline;">
                                                                            <span style="font-size: 14px; line-height: 26.6px;">{{config('mail.template.website')}}</span>. 
                                                                        </a>
                                                                    </span>
                                                                    <br />
                                                                    <span style="text-decoration: underline; font-size: 14px; line-height: 26.6px;">
                                                                        <a href="mailto:{{config('mail.template.address')}}" style="color: #f1602a; font-size: 14px; line-height: 26.6px; text-decoration: underline;">
                                                                            <span style="font-size: 14px; line-height: 26.6px;">{{config('mail.template.address')}}</span>. 
                                                                        </a>
                                                                    </span>
                                                                    <br />{{config('mail.template.contact')}}
                                                                    <br />
