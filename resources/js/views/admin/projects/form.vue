                    ...
                    <div class="card-header py-3">
                        <div class="row">
                            ...
                            <div class="col-md-8 d-flex justify-content-end align-items-center">
                                <a href="#" class="btn btn-sm btn-primary btn-icon-split" @click="onSubmit()" >
                                    <span class="icon text-white-50"><i class="fas fa-save"></i></span>
                                    <span v-if="formtype === 'add'" class="text">Save</span>
                                    <span v-if="formtype === 'edit'" class="text">Update</span>
                                </a>
                                <a v-if="formtype === 'add'" href="#" class="btn btn-sm btn-secondary btn-icon-split ml-2" @click="resetForm()" >
                                ...
                                <b-row>
                                    <b-col cols="12">
                                        <b-form-group id="example-input-group-1">
                                            ...
                                            <b-form-input id="example-input-1" name="example-input-1" class="mb-2 mr-sm-2 mb-sm-0" placeholder="Project Name"
                                                v-model="$v.form.name.$model" :state="validateState('name')" aria-describedby="input-1-live-feedback" ></b-form-input>
                                ...
                                <b-row>
                                    <b-col cols="12">
                                        <b-form-group id="example-input-group-2">
                                            ...
                                            <b-form-input id="example-input-2" name="example-input-2" class="mb-2 mr-sm-2 mb-sm-0" placeholder="Slug"
                                                v-model="$v.form.slug.$model" :state="validateState('slug')" aria-describedby="input-2-live-feedback" ></b-form-input>
                                ...
                                <b-row>
                                    <b-col cols="12">
                                        <b-form-group id="example-input-group-3">
                                            ...
                                            <b-form-input id="example-input-3" name="example-input-3" class="mb-2 mr-sm-2 mb-sm-0" placeholder="Folder"
                                                v-model="$v.form.folder.$model" :state="validateState('folder')" aria-describedby="input-3-live-feedback" ></b-form-input>
